...
**Самоверификация E5 (2026-09-20)**: `sahi_flight_recall()` вердикта, прогнанная по старому
канону `mmaud_sahi_full.csv`, даёт 94,520% — baseline it-63 воспроизведён точно, сегментация
вердикта и исходного скрипта идентичны (тот же bisect по лидарному GT, z>1 м).

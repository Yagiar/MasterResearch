...
FILES = {
    ...
    "research/it73_sahi_contour.txt": ROOT / "research/it73_sahi_contour.txt",
    "research/yolo_sandbox_frames_old_sahi640.csv": ROOT / "research/yolo_sandbox_frames_old_sahi640.csv",
    ...
    "research/it79_old.csv": ROOT / "research/it79_old.csv",
    "research/it79_new.csv": ROOT / "research/it79_new.csv",
    "research/it79_manifest.csv": ROOT / "research/it79_manifest.csv",
    ...
    "research/it81_live_ab.csv": ROOT / "research/it81_live_ab.csv",
    "research/it81_ab_summary.txt": ROOT / "research/it81_ab_summary.txt",
    "research/it81_ab_run.sh": ROOT / "research/it81_ab_run.sh",
    "research/it82_bg_fp.csv": ROOT / "research/it82_bg_fp.csv",
    "research/it82_bg_summary.txt": ROOT / "research/it82_bg_summary.txt",
    "research/it82_bg_run.sh": ROOT / "research/it82_bg_run.sh",
    "research/it82_bg_fp_eval.py": ROOT / "research/it82_bg_fp_eval.py",
    "research/it83_sanity.sh": ROOT / "research/it83_sanity.sh",
    "research/it83_sanity_eval.py": ROOT / "research/it83_sanity_eval.py",
    "research/it83_sanity_summary.txt": ROOT / "research/it83_sanity_summary.txt",
    "research/it84_paired_run.sh": ROOT / "research/it84_paired_run.sh",
    "research/it84_paired_eval.py": ROOT / "research/it84_paired_eval.py",
    "research/it84_paired.csv": ROOT / "research/it84_paired.csv",
    "research/it84_paired_summary.txt": ROOT / "research/it84_paired_summary.txt",
    "research/it85_sweep_run.sh": ROOT / "research/it85_sweep_run.sh",
    "research/it85_sweep_eval.py": ROOT / "research/it85_sweep_eval.py",
    "research/it85_rerun_half_fps.sh": ROOT / "research/it85_rerun_half_fps.sh",
    "research/it85_sweep.csv": ROOT / "research/it85_sweep.csv",
    "research/it85_sweep_summary.txt": ROOT / "research/it85_sweep_summary.txt",
    "research/it88_sahi_tiled.py": ROOT / "research/it88_sahi_tiled.py",
    "research/it88_tile_aggregate.py": ROOT / "research/it88_tile_aggregate.py",
    "research/it88_dump_run.sh": ROOT / "research/it88_dump_run.sh",
    "research/it88_bg400_old.csv": ROOT / "research/it88_bg400_old.csv",
    "research/it88_bg400_new.csv": ROOT / "research/it88_bg400_new.csv",
    "research/it88_mmaud_old.csv": ROOT / "research/it88_mmaud_old.csv",
    "research/it88_mmaud_new.csv": ROOT / "research/it88_mmaud_new.csv",
    "research/it88_tile_agg.csv": ROOT / "research/it88_tile_agg.csv",
    ...
    "research/it86_full_negative_run.sh": ROOT / "research/it86_full_negative_run.sh",
    "research/it87_build_media_index.sh": ROOT / "research/it87_build_media_index.sh",
    ...
    "research/it89_skyguard_gate.txt": ROOT / "research/it89_skyguard_gate.txt",

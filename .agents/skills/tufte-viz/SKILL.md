---
name: tufte-viz
description: Ideate and critique figures using Edward Tufte's principles: graphical integrity (lie factor, baselines, 3D distortion), data-ink ratio, chartjunk removal, six principles of analytical design, small multiples, sparklines. Use when designing or reviewing charts and figures for a paper, thesis, or presentation.
---

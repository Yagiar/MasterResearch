---
name: backmanreview
description: Six-agent pre-submission referee report targeting a specified journal: spelling/grammar, internal consistency, unsupported claims, mathematics/notation, tables/figures, contribution evaluation. Use for a final pre-submission check of a paper or thesis before submitting.
---

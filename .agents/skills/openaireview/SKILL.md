---
name: openaireview
description: Deep multi-agent academic paper review: first understand the full paper, then run 6-9 parallel section reviewers plus cross-cutting checks, consolidating findings as major/moderate/minor. Use for an in-depth structured review of an academic paper.
---

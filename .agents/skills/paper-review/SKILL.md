---
name: paper-review
description: Review academic research papers using five established peer-review frameworks (Edmans editorial assessment, Nyhan checklist, Humphreys critique, Blattman empirical guide, Evans/Bellemare on intros and abstracts). Use when reviewing, critiquing, or writing a referee report for a research paper, thesis chapter, or manuscript — even if the user just says 'review this paper'.
---
